									...
									<Card key={request.friendshipId}>
										<CardContent className="flex items-center justify-between gap-3">
											...
											<Button
												...
												// biome-ignore lint/performance/noJsxPropsBind: per-row accept action
												onClick={() =>
									...
									<Card key={friendship.friendshipId}>
										<CardContent className="flex items-center justify-between gap-3">
											...
											<div className="flex items-center gap-2">
												<Button
													// biome-ignore lint/performance/noJsxPropsBind: per-row mute toggle
													onClick={() =>
														muteMutation.mutate({
												...
												<Button
													...
													// biome-ignore lint/performance/noJsxPropsBind: per-row ring action
